  ...
  <nav class="top-0 bg-blue-200 sticky z-50">
    ...
    if ($logo) :
      ...
      <div class="block md:hidden p-0">
        ...
        <div
          class="mobile-menu md:hidden absolute top-0 left-0 bg-blue-100 h-screen w-64 transform translate-x-0 transition-transform duration-300 ease-in-out overflow-y-auto"
          style="display: none;">
    ...
    if ($logo) :
      ...
      <div class="hidden md:flex gap-4 items-center">
        <?php
                ...
                ?>
        <a href="https://alpinecodex.com/windpress"
          class="hidden md:block px-4 ml-2 py-2 bg-blue-600 hover:bg-blue-900 text-white">
          Download Now
        </a>
      </div>
      <!-- End Desktop Menu -->
