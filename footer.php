<footer class="bg-blue-100">
  <div class="container flex flex-col m-auto gap-8 max-w-screen-lg px-6 py-12 md:py-24">
    ...
    <div class="md:p-6 md:border border-blue-300 w-fit border-dashed">
      ...
      <form class="md:flex h-fit max-w-full" action="your-submission-handler.php" method="post">
        <input type="email" name="email" placeholder="Enter your email" required
          class="border px-4 py-2 w-full md:w-64 focus:outline-none focus:ring focus:border-blue-300 mb-2 md:mb-0">
        <button type="submit"
          class="bg-blue-500 w-full md:w-36 text-white px-4 py-2 hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300">Subscribe</button>
      </form>
    ...
    <div class="text-sm text-blue-300">
      <p>Created by <a href="https://alpinecodex.com">Alpine Codex</a>. Code by <a
          href="https://coywolf.com/">Coywolf</a>, <a href="https://brijr.dev">Bridger Tower</a>, and <a
          href="https://cameronyoungblood.com">Cameron Youngblood</a>.</p>
    </div>
  </div>
</footer>
